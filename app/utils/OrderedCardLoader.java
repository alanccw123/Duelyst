...
import structures.SpellCard.EntropicDecay;
import structures.SpellCard.StaffOfYKir;
import structures.SpellCard.SundropElixir;
import structures.SpellCard.Truestrike;
...
public class OrderedCardLoader {
	...
	public static List<Card> getPlayer2Cards() {
		...
		cardsInDeck.add(BasicObjectBuilders.loadCard(StaticConfFiles.c_staff_of_ykir, 22, StaffOfYKir.class));
		...
		cardsInDeck.add(BasicObjectBuilders.loadCard(StaticConfFiles.c_staff_of_ykir, 32, StaffOfYKir.class));
