...
/*
 * This class extends the base Unit class and represents the AI avatar
 */
public class AIAvatar extends Unit{
    ...
    // overides the default setHealth method to propagate any health change to the AI player
    @Override
    public void setHealth(int health) {
        ...
        // if health equals to zero, Player wins the game
        if (getHealth() <= 0) {
